		...
		<div className="about">
			...
			<div className="about__right">
				...
				<p className="about__text">
					...
					osiągnięcia niesamowitych rzeczy. Moim celem jest pomoc w odkryciu
					tego potencjału i wspieranie Cię na drodze do osiągnięcia Twoich celów
					zdrowotnych i fitnessowych. Specjalizuję się w tworzeniu
					indywidualnych programów treningowych, które są dostosowane do Twoich
					unikalnych potrzeb, poziomu zaawansowania oraz stylu życia.
				</p>
				<p className="about__text">
					Moje podejście jest holistyczne - zależy mi nie tylko na Twojej formie
					fizycznej, ale również na poprawie samopoczucia i zdrowia
					psychicznego. W pracy z klientami kładę duży nacisk na edukację i
					motywację, abyś mógł/mogła kontynuować zdrowy styl życia przez długie
					lata.
				</p>
				<p className="about__text">
